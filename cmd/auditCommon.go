...
func addPackageAuditFlags(cmd *cobra.Command, view, failOn, ignoreFile *string) {
...
func runPackageAudit(target inventory.Target, view, failOn, ignoreFilePath string) error {
